...
$MESS['CAWEB_PRICE_CHANGE'] = 'Выбранный способ оплаты влияет на конечную стоимость товара при оформлении. Спец.цена при оформлении товара в кредит не действует.';
$MESS["SBB_ORDER_ITEM_WRONG_AVAILABLE_QUANTITY"] = "Извините, но указанное количество товара в данный момент недоступно.<br>Установлено предыдущее корректное значение.";