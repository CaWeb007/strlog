...
function FilterConditionsParameterControl(data, params)
{
	...
	BX.addCustomEvent('onTreeCondItemDelete', BX.proxy(this.onChangeForm, this));
...
FilterConditionsParameterControl.prototype =
{
	...
	modifyCondValueGroup: function(ctrl)
	{
		...
		var propertyPrefix = 'CondIBProp',
			allowedFields = [
				'CondIBXmlID', /*'CondIBActive',*/ 'CondIBSection', 'CondIBElement','CondIBDateActiveFrom', 'CondIBDateActiveTo',
