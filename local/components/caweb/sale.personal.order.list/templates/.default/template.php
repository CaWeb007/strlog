...
Asset::getInstance()->addJs("/local/components/caweb/sale.order.payment.change/templates/.default/script.js");
Asset::getInstance()->addCss("/local/components/caweb/sale.order.payment.change/templates/.default/style.css");
