...
class CBitrixBasketComponent extends CBitrixComponent
{
	...
	protected function initializeBasketOrderIfNotExists(Sale\Basket $basket)
	{
		if (!$basket->getOrder())
		{
            ...
            /*Pr($discounts->getShowPrices());
            $showPrices['BASKET'][4666]['SHOW_PRICE'] = 550;
			$showPrices['BASKET'][4666]['SHOW_DISCOUNT'] = 6;
			//$showPrices['BASKET'][4666]['SHOW_DISCOUNT_PERCENT'] = 15;
			$showPrices['BASKET'][4666]['REAL_PRICE'] = 550;
			$showPrices['BASKET'][4666]['REAL_DISCOUNT'] = 6;*/
