...
$module_id = 'caweb.main'; //обязательно, иначе права доступа не работают!
...
$aTabs = array(
    array(
        ...
        'TAB' => 'settings',
        'OPTIONS' => array(
            array('field_text', 'textarea',
                '',
                array('textarea', 10, 50)),
            array('field_line', 'text',
                '',
                array('text', 10)),
            array('field_list', 'select',
                '',
...
if ($request->isPost() && $request['Update'] && check_bitrix_sessid())
{
    ...
    {
        if (!is_array($aTab['OPTIONS'])) continue;
