...
$NoView = array('BRAND','ACTION','ISOVER_ID','PROIZVODITEL_1,','BEST_PRICE','RAZRESHENNYY_OPLATY_BONUSAMI','_POROGA_NACHISLENIYA_BONUSOV','NAIMENOVANIE_DLYA_SAYTA','CML2_BAR_CODE','CML2_ARTICLE','CML2_ATTRIBUTES','CML2_TRAITS','CML2_BASE_UNIT','CML2_TAXES','CML2_MANUFACTURER','BLOG_POST_ID','BLOG_COMMENTS_CNT','BONUS','ON_DESCOUNT','AMOUNT_OF_DISCOUNT','ATT_INSTRUCTIONS','BREND_LOGO','BREND','MORE_PHOTO','FILES','NALICHIE','NEKONDITSIYA','NELZYA_OPLACHIVAT_BONUSAMI','NE_NACHISLYAT_BONUSY','FLAG');
