...
console.log(this.errorCode);
	if (0 === this.errorCode)
	{
		...
		console.log("ddd",this.productType);
		switch (this.productType)
		{
			case 0://no catalog
			case 1://product
			case 2://set
				if (this.product.useSlider)
				{
					...
					SliderImgs = BX.findChildren(this.product.slider.LIST, {tagName: 'div'}, true);
					if (!!SliderImgs && 0 < SliderImgs.length)
					{
						for (j = 0; j < SliderImgs.length; j++)
						{
							BX.bind(SliderImgs[j], 'mousemove', BX.delegate(this.ProductSelectSliderImg, this));
						}
					}
...
window.JCCatalogElement.prototype.setCurrentImg = function(img, showImage)
{
	...
	if (showImage && !!this.obPict)
	{
		...
		this.obPict.setAttribute("data-zoom-image", this.currentImg.src);
