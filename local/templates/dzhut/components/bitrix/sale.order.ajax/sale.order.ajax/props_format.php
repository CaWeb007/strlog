					...
					<?if(intval(intval($arProperties["ID"])) == 6) echo "style='display:none;'"; ?>>
						...
						if ($arProperties["TYPE"] == "CHECKBOX")
						{
							...
							<div class="bx_block r1x3 pt8">
								...
								<input type="checkbox" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" value="Y" <?if($USER->IsAuthorized()):?> checked="checked" <?endif;?>>
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							...
							<?//====Дополнительные свойства Фамилия, Имя, Отчество ====//?>
								...
								<div id="email-tip" class="topltip-error">
								...
								<div id="order_phone" class="topltip-error">
									<div class="close">X</div>
								...
								<input type="text" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" placeholder="Телефон"/>	
									<?global $USER;
									...
									<?endif?>
								<?endif;?>
								<input id="CONFIRM_PHONE_SUCCESS" type="hidden" name="CONFIRM_PHONE_SUCCESS" value="N">
							</div>
							<?
						}
