...
$arNoViewProp = array('_1','TSENA_ZA_M2','ATT_INSTRUCTIONS','ACTION_1','SAP','ISOVER_ID','VYVOD','BLOG_POST_ID','PROIZVODITEL_1','CML2_BAR_CODE','CML2_ARTICLE','CML2_ATTRIBUTES','CML2_TRAITS','CML2_BASE_UNIT','CML2_TAXES','MORE_PHOTO','FILES','CML2_MANUFACTURER','BONUS','INSTRUKTSIYA_PO_SBORKE','GARANTIYA','BREND','248','BEST','HIT','NEW','MAIN','RAZRESHENNYY_OPLATY_BONUSAMI','_POROGA_NACHISLENIYA_BONUSOV','POD_ZAKAZ_CHEREZ','NALICHIE','PROIZVODITEL','BRAND','MORE_PHOTO','ON_DESCOUNT','ATT_YOUTUBE','BREND_LOGO','BEST_PRICE','vote_count','vote_sum','rating','ATT_RELATIONS_FRONT','ZVEZDA','TIP','NALICHIE','NEKONDITSIYA','NELZYA_OPLACHIVAT_BONUSAMI','NE_NACHISLYAT_BONUSY','FLAG');
