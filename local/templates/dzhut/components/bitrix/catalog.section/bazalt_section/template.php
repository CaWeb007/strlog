...
<div class="clear"></div>
<div class="wrapper">
	<div style="box-sizing: border-box; width:160px;height:auto;margin: 0;padding: 25px 0;float: left; border: none;font-size:16px;text-align: center;"></div>
	<div style="box-sizing: border-box; width:300px;height:auto;margin: 0;padding: 35px 0 35px 0;float: left; border: 1px solid #fff;border-right: none;font-size:16px;text-align: center;background:#dddddd;">Наименование</div>
	<div style="box-sizing: border-box; width:75px;height:auto;margin: 0;padding: 26px 0 26px 0;float: left; border: 1px solid #fff;border-right: none;font-size:16px;text-align: center;background:#dddddd;">Толщина, мм</div>
	<div style="box-sizing: border-box; width:80px;height:auto;margin:39px 0 0 0;padding:  16px 0 15px 0;float: left; border: 1px solid #fff;border-right: none;font-size:16px;text-align: center;background:#dddddd;">длина, мм</div>
	<div style="box-sizing: border-box; width:80px;height:auto;margin: 39px 0 0 0;padding:  16px 0 15px 0;float: left; border: 1px solid #fff;border-right: none;font-size:16px;text-align: center;position:relative;background:#dddddd;">ширина, мм
		<div style="position:absolute;right: -1px;top:-40px;width:161px;padding: 11px 0 12px 0;border:1px solid #fff;background: #fff;box-sizing: border-box;font-size:19px;background:#dddddd;">Размер</div>
	</div>
	<div style="box-sizing: border-box; width:80px;height:auto;margin: 0;padding: 26px 0 26px 0;float: left; border: 1px solid #fff;border-right:none;font-size:16px;text-align: center;background:#dddddd;">Плотность, кг/м<sup>2</sup></div>
	<div style="box-sizing: border-box; width:100px;height:auto;margin: 0;padding: 17px 0 17px 0;float: left; border: 1px solid #fff;border-right:none;font-size:16px;text-align: center;background:#dddddd;">Тепло-<br />проводность, Вт/(м*К)</div>
	<div style="box-sizing: border-box; width:75px;height:auto;margin: 0;padding: 26px 0 26px 0;float: left; border: 1px solid #fff;border-right:none;font-size:16px;text-align: center;background:#dddddd;">Площадь, м<sup>2</sup></div>
	<div style="box-sizing: border-box; width:80px;height:auto;margin: 0;padding: 17px 0 17px 0;float: left; border: 1px solid #fff;border-right:none;font-size:16px;text-align: center;background:#dddddd;">Кол-во плит в упак., шт</div>
	<div style="box-sizing: border-box; width:80px;height:auto;margin: 0;padding: 26px 0 26px 0;float: left; border: 1px solid #fff;border-right:none;font-size:16px;text-align: center;background:#dddddd;">Цена за упак., руб</div>
</div><!--/wrapper-->

<div class="wrapper">
	<div class="table-good-title">TEPlit</div>
	<div class="table-good-image-1" style="display: flex;align-items:center;"> 
		<a class="fancybox-good-image" href="images/bazalt-main.png" rel="fancy-bazalt-1" title="Базальтовый утеплитель TEPlit">
			<div class="lupa"></div>
			<img id="fancy-bazalt-1" src="images/bazalt-main.png" data-zoom-image="images/bazalt-main.png" alt="Базальтовый утеплитель" />
		</a>
	</div>
	<div class="flex-good-data-wrapper flex-good-data-wrapper-1">
			<?foreach($arResult['ITEMS'] as $arItem): ?>
			<?
			$this->AddEditAction($arItem['ID'], $arItem['EDIT_LINK'], $strElementEdit);
			$this->AddDeleteAction($arItem['ID'], $arItem['DELETE_LINK'], $strElementDelete, $arElementDeleteParams);
			...
			?>
			<?if($arItem['PROPERTIES']['BREND']['VALUE'] == 'nazarovo'):?>
				<?
				$str=strpos($arItem['NAME'], ",");
				$arItem['NAME']=substr($arItem['NAME'], 0, $str);
				?>
				<div class="flex-good-data">
					<div class="flex-good-desc flex-good-name"><a href="<?=$arItem['DETAIL_PAGE_URL'];?>" target="_blank"><?=$arItem['NAME'];?></a></div>
					<?if(!empty($arItem['PROPERTIES']['TOLSHCHINA_MM_1']['VALUE'])):?>
					<div class="flex-good-desc flex-good-tolshina"><?=$arItem['PROPERTIES']['TOLSHCHINA_MM_1']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-tolshina">-</div>
					<?endif;?>
					<?if(!empty($arItem['PROPERTIES']['DLINA_MM_1']['VALUE'])):?>
					<div class="flex-good-desc flex-good-dlina"><?=$arItem['PROPERTIES']['DLINA_MM_1']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-dlina">-</div>
					<?endif;?>
					<?if(!empty($arItem['PROPERTIES']['SHIRINA_MM_1']['VALUE'])):?>
					<div class="flex-good-desc flex-good-shirina"><?=$arItem['PROPERTIES']['SHIRINA_MM_1']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-shirina">-</div>
					<?endif;?>
					<?if(!empty($arItem['PROPERTIES']['PLOTNOST_KG_M2_1']['VALUE'])):?>
					<div class="flex-good-desc flex-good-plotnost"><?=$arItem['PROPERTIES']['PLOTNOST_KG_M2_1']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-plotnost">-</div>
					<?endif;?>
					<?if(!empty($arItem['PROPERTIES']['KOEFFITSIENT_TEPLOPROVODNOSTI_VT_M_K']['VALUE'])):?>
					<div class="flex-good-desc flex-good-teplo"><?=$arItem['PROPERTIES']['KOEFFITSIENT_TEPLOPROVODNOSTI_VT_M_K']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-teplo">-</div>
					<?endif;?>
					<?if(!empty($arItem['PROPERTIES']['PLOSHCHAD']['VALUE'])):?>
					<div class="flex-good-desc flex-good-ploshad"><?=$arItem['PROPERTIES']['PLOSHCHAD']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-ploshad">-</div>
					<?endif;?>
					<?if(!empty($arItem['PROPERTIES']['KOLICHESTVO_V_UPAKOVKE_SHT']['VALUE'])):?>
					<div class="flex-good-desc flex-good-quant"><?=$arItem['PROPERTIES']['KOLICHESTVO_V_UPAKOVKE_SHT']['VALUE'];?></div>
					<?else:?>
					<div class="flex-good-desc flex-good-quant">-</div>
					<?endif;?>
					<div class="flex-good-desc flex-good-price"><? echo $arItem['PRICE_MATRIX']['MATRIX']['1']['0']['DISCOUNT_PRICE']?></div>
					<div class="flex-good-desc flex-good-buybtn"><button class="order-send" data-name="<? echo $arItem['NAME'];?>">Заказать</button></div>
				</div>
			<?endif;?>
			<?endforeach;?>
	</div>
...
<div class="wrapper">
	<div class="table-good-title">ТехноНИКОЛЬ</div>
	<div class="table-good-image-2" style="display: flex;align-items:center;">
		<a class="fancybox-good-image" href="images/seee.png" rel="fancy-bazalt-2" title="Базальтовый утеплитель ТЕХНОНИКОЛЬ">
			<div class="lupa"></div>
			<img id="zoom_dzhut_2" src="images/seee1.png" data-zoom-image="images/seee1.png" alt="Базальтовый утеплитель" />
		</a>
	</div>
	<div class="flex-good-data-wrapper flex-good-data-wrapper-2">
			<?foreach($arResult['ITEMS'] as $arItem): ?>
			<?
			$this->AddEditAction($arItem['ID'], $arItem['EDIT_LINK'], $strElementEdit);
			$this->AddDeleteAction($arItem['ID'], $arItem['DELETE_LINK'], $strElementDelete, $arElementDeleteParams);
			...
			?>
			<?if($arItem['PROPERTIES']['BREND']['VALUE'] == 'tehnonikol'):?>
			<?
			$str=strpos($arItem['NAME'], ",");
			$arItem['NAME']=substr($arItem['NAME'], 0, $str);
			?>
