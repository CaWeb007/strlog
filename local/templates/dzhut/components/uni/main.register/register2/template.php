...
<h4 class="slug-call-back"><?=GetMessage("AUTH_REGISTER")?></h4>
...
<input id="CHECKPHONE" type="hidden" name="CHECKPHONE" value="Y">
</div>
...
<button id="closeRG" class="close-call-back">Скрыть</button>
</form>
