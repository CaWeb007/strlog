...
//array_swap($arResult["GRID"]["HEADERS"],2,3);
$ArBonusTotal = 0;
if ($normalCount > 0):
?>
<?
...
<div id="basket_items_list">
							...
							?>
								<td class="custom price">
									...
									if (floatval($arItem["DISCOUNT_PRICE_PERCENT"]) > 0)
										echo $arItem["FULL_PRICE_FORMATED"]*$arItem['QUANTITY'];
									else
									...
									?>
									<div class="incart-bonus">
								
									<div class="product-bonus">
									<a href="">Бонус <span class="orange">
										<?if(!empty($arResult['GRID']['ROWS']['ELEMENT']) && floatval($arItem["DISCOUNT_PRICE_PERCENT"]) == 0):
											echo $arResult['GRID']['ROWS']['ELEMENT'][$arItem['PRODUCT_ID']]*$arItem['QUANTITY'];
											$ArBonusTotal += $arResult['GRID']['ROWS']['ELEMENT'][$arItem['PRODUCT_ID']]*$arItem['QUANTITY'];
											else:
											echo "0";
											endif;?>
										</span>
								...
								ими ваши покупки!</p>
										<p>1 бонус = 1 рубль</p>
										<a href="/bonusnaya-karta/" class="orange" href="">Узнать больше</a>
										</div>
									</div>	
								</td>
								<?
								...
								?>
								<td class="price hello" style="display:none">
	...
	<div class="bx_ordercart_order_pay">
		...
		<div class="bx_ordercart_order_pay_left" id="coupons_block" style="display:none">
			...
			<table class="bx_ordercart_order_sum">
				...
				<?endif;?>
					<tr>
						...
						<?if (floatval($arResult["DISCOUNT_PRICE_ALL"]) > 0):?>
							<span style="text-decoration:line-through; color:#828282;font-size:20px;display:inline-block;margin-left:15px;" id="PRICE_WITHOUT_DISCOUNT">
								<?=$arResult["PRICE_WITHOUT_DISCOUNT"]?>
							</span>
						<?endif;?>
								<div class="incart-bonus">
