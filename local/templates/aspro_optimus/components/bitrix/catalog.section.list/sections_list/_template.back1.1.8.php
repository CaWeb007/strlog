					...
					<tr>
						...
						<td class="section_info">
							<ul>
								...
								<li class="sect"><a href="<?=$arItem["SECTION_PAGE_URL"]?>" class="dark_link"><?=$arItem["NAME"]?><? echo $arItem["ELEMENT_CNT"]?'&nbsp;<span style="color:#00adee !important;">'.$arItem["ELEMENT_CNT"].'</span>':'';?></a></li><br>
									<?}
								}?>
							</ul>
						</td>
