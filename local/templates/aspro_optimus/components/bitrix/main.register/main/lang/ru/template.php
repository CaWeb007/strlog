<?
	...
	$MESS["REGISTER_FIELD_TEXT_LAST_NAME"] = "Ваша фамилия - это ваш идентификатор в обществе))";
	$MESS["REGISTER_FIELD_TEXT_SECOND_NAME"] = "Ваше отчество необходимо для того, чтобы мы звали вас уважительно)";
