                        ...
                        <div class="form-control bg">
                            <div class="wrap_md">
                                <div class="iblock label_block">
                                    <label for="user_group">Группа пользователя<span class="star">*</span></label>
                                    <select name="select_user_group" id="user_group">
                                        <option value="user_group_fiz_kp" name="user_group_fiz_kp">Конечный покупатель</option>
                                        <option value="user_group_fiz_kms" name="user_group_fiz_kms">Коттеджное малое строительство</option>
                                    </select>
                                </div>
