...
<?foreach($arResult["ACCOUNT_LIST"] as $accountValue):?>
	<?if($accountValue["CURRENCY"] == "RUB"):?>
        ...
        <?if(!Helper::getInstance()->checkBonusAccess() && !$bonus) continue?>
            <div class="user-bonus-wrapper">
                ...
                <?endif;?>
                <!--<div class="usrdata" style="display: none;position: fixed;top: 0;right: 0;bottom: 0;left: 0;background: #fff;"></div>-->
