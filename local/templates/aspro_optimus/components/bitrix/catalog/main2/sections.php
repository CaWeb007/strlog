...
<style>
    #pagetitle{margin: 0 0 -35px 0;}
    .sort_header.view_table{margin: 0;}
</style>
...
<?php/*Current problem starts here*/?>
<?$isAjax="N";?>
<?php/*Current problem ends here*/?>
...
<div class="right_block1 clearfix catalog <?=strtolower($TEMPLATE_OPTIONS["TYPE_VIEW_FILTER"]["CURRENT_VALUE"]);?>" id="right_block_ajax">
	...
	<?$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"AJAX_REQUEST" => $isAjax,
			"ELEMENT_SORT_FIELD" => catalog_PRICE_11,//$sort,
