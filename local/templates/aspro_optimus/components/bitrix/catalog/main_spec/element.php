...
<?else:?>
	<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/spectrum.js"></script>
	...
	<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.element/fast_view/script.js"></script>
<?endif?>
