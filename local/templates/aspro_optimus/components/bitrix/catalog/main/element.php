...
if(!$FAST_VIEW):
	...
	<?COptimus::AddMeta(
		array(
		//	'og:description' => $arElement['DETAIL_TEXT'] ? $arElement['DETAIL_TEXT'] : $arElement['PREVIEW_TEXT'],
			'og:image' => (($arElement['PREVIEW_PICTURE'] || $arElement['DETAIL_PICTURE']) ? CFile::GetPath(($arElement['PREVIEW_PICTURE'] ? $arElement['PREVIEW_PICTURE'] : $arElement['DETAIL_PICTURE'])) : false),
		)
	);?>

<?else:?>
	<script type="text/javascript" src="/bitrix/templates/aspro_optimus/js/spectrum.js"></script>
	<script type="text/javascript" src="/bitrix/components/aspro/theme.optimus/templates/.default/script.js"></script>
	<script type="text/javascript" src="/bitrix/components/bitrix/search.title/script.js"></script>
	<script type="text/javascript" src="/bitrix/templates/aspro_optimus/components/bitrix/catalog.element/fast_view/script.js"></script>
<?endif?>

<div class="catalog_detail" itemscope itemtype="http://schema.org/Product">
	<?$ElementID = $APPLICATION->IncludeComponent(
		"bitrix:catalog.element",
		$FAST_VIEW?"fast_view":"main",
		Array(
				...
				<li class="tab <?=$code?>_wrapp" data-code="<?=$code?>">
					...
					<?}else{?>
						<ul class="tabs_slider <?=$code?>_slides wr">
							<?if($code == "EXPANDABLES"):?>
							<?$GLOBALS['arrFilter'.$code] = array( "SECTION_ID" => $arSection['ID'], "!ID" => $arElement["ID"]);?>
							<?else:?>
